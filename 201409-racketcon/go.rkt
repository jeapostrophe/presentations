...
(go! (relative-placer 1/2 1/2 'cc))
(add! (reso-box 256 224 "SNES"))
(commit!)
(define snes-exact 25)
(go! (relative-placer 1/2 1/2 'cc))
(add! (reso-box (* 16 snes-exact) (* 9 snes-exact) "16:9 SNES"))
(commit!)
(go! (relative-placer 1/2 1/2 'cc))
(define snes-even 26)
(add! (scale (rectangle (* 16 snes-even) (* 9 snes-even)) 2))
(go! (relative-placer 1/2 0.9 'cc))
(add! (text (format "16:9 at ~a scale" snes-even) null 60))
(commit!) (restore! gbppu)
...
(add! (text "vs 32 per line on SNES" null 60))
...
(add! #:tag 'game (text "Play : Skill -> Score" null 60))
(add! #:tag 'score (blank))
(commit!)
...
(go! (relative-placer 0.5 0.5 'cb))
(add! (text "Game : Level -> Play" null 60))
(commit!)
...
(go! (relative-placer 0.5 0.5 'cb))
(add! (text "Game.Gen : Params -> Level" null 60))
(commit!) (restore! enumerator)

(go! (relative-placer 0.5 0.25 'ct))
(add! #:tag 'cg.call (text "Game.Gen(Underwater, Easy)" null 60))
(commit!)
...
(go! (relative-placer 0.5 0.15 'ct))
(add! (text "Series : Version -> Game" null 60))
...
(add! (text "Game : Level -> Play" null 60))
(commit!)
(add! (text "Play : Skill -> Score" null 60))
...
(aka "Enumerator" " a.k.a. series, games, and Godel bijections")
